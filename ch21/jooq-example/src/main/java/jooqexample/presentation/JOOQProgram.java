package jooqexample.presentation;

import jooqexample.Bootstrapper;
import jooqexample.Bootstrapper.ObjectFactory;
...
import jooqexample.application.businessUseCases.NewAuctionRequest;
...
class JOOQProgram {
    ...
    public static void main(String[] args) {
        objectFactory = Bootstrapper.startup(args[0]); // DB URL, e.g. jdbc:sqlite:/path/to/src/main/resources/ch21.db
